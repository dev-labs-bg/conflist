...
class Header extends Component {
    render () {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-4 px-5">
            ...
            <div class="collapse navbar-collapse justify-content-end ml-md-4 text-left" id="navbarTogglerDemo02">

                <form class="form-inline mt-xs-2 mr-xl-5">
                    <input class="form-control mx-lg-3" type="text" placeholder="Search by location or technology..." />
                </form>
                ...
                <ul class="nav navbar-nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Suggest a conference</a>
                    </li>
                    ...
                    <button type="button" class="btn btn-primary align-self-start font-weight-bold ">Register</button>
        ...
        <div class="background-img">
            <h2 class="register__title mx-auto font-weight-bold mt-4">Discover your next conference you wanna go!</h2>
            <p class="register__text mx-auto font-weight-normal mt-3">Conf List surfaces the best international conferences, worldwide. It's a place for conference-loving enthusiasts to collect conferences and to subscribe for upcoming events related to the #tags they care about.</p>
            <button type="button" class="btn btn-primary font-weight-bold mx-auto mt-3">Register</button>
        </div>
